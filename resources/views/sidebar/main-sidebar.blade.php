        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Employees </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        <li><a href="{{ route('form.allemployee.page') }}">Employees List </a></li>
                        <li><a href="{{ route('form.allleave.page') }}">Leaves </a></li>
                        <li><a href="{{ route('form.allHoliday.page') }}">Holidays </a></li>
                        <li><a href="{{ route('form.Attendance.all') }}">Attendance </a></li>
                    </ul>
                </li>
                <li class="submenu"> <a href="#"><i class="far fa-money-bill-alt"></i> <span> Accounts </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        <li><a href="{{route('form.Invoice.all')}}">Invoices </a></li>
